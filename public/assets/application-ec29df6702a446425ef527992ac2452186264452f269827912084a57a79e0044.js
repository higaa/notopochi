...
(function() {
  var addListenerPoint, initialize;

  addListenerPoint = function(m_map, m_marker, m_content) {
  ...
  initialize = function() {
    var bounds, contentString, i, icon, iconOffset, iconPosition, iconShadowSize, iconShadowUrl, iconSize, iconUrl, latlng, map, marker, mopts, opts, shadow;
  ...
  $(function() {
    return $("div#map_canvas").ready(function() {
      return initialize();
    });
  });
